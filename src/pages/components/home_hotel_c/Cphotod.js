  ...
  return (
    <div style={{ opacity: 1 }}>
      <div className="flex justify-center gap-4">
        {/* Image Grid */}
        <div className="aspect-w-1 aspect-h-1 w-1/2 overflow-hidden xl:aspect-w-7 xl:aspect-h-8 bg-background-500 dark:bg-background-700 flex flex-col items-center justify-center">
          <Image
            alt="Hotels"
            src="/images/home_baima_03.jpg"
            width={1920}
            height={2888}
